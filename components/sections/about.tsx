...
// import { Clock, Shield, Play, ArrowRight, CheckCircle, ArrowLeft } from "lucide-react"
...
//                             <span className="block">Atendimento de</span>
//                             <span className="block bg-gradient-to-r from-red-500 to-red-600 bg-clip-text text-transparent">Primeira Linha</span>
//                         </h2>
